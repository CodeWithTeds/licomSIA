...
<div class="container-fluid px-4">
    ...
    <nav class="flex mb-5" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li class="flex items-center">
                ...
                <a href="{{ route('students.index') }}" class="ml-1 text-gray-700 hover:text-primary md:ml-2">Students</a>
            </li>
            <li class="flex items-center">
                <svg class="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="flex items-center px-6 py-4 bg-gray-50 border-b border-gray-200">
            ...
            <h3 class="text-lg font-semibold text-gray-700">Student Information</h3>
        </div>
        <div class="p-6">
            @if ($errors->any())
            ...
            <form action="{{ route('students.store') }}" method="POST">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('students.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 transition-colors">Cancel</a>
