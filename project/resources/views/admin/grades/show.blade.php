...
@section('content')
    <div class="bg-white rounded-lg shadow-sm p-6">
        <h3 class="text-lg font-semibold text-dark mb-4">Grades for {{ $student->first_name }} {{ $student->last_name }}</h3>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-4">No grades found for this student.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
