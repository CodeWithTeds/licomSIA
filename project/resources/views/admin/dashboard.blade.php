    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('instructors.create') }}" class="flex items-center p-3 bg-green-50 hover:bg-green-100 rounded-lg transition">
                    <div class="rounded-full bg-green-500 text-white p-2 mr-3">
                        <i class="fas fa-user-tie"></i>
                    </div>
                    <span class="font-medium">Add New Instructor</span>
                </a>
